...
public class VROptionLayout
{
    ...
    public VROptionLayout(Class<? extends GuiScreen> screen, BiFunction<GuiVROptionButton, Vec2f, Boolean> handler, Position pos, float row, boolean enabled, String title)
    {
        _pos = pos;
        _row = row;
        if (title != null)
    ...
    public VROptionLayout(Class<? extends GuiScreen> screen, Position pos, float row, boolean enabled, String title)
    {
        _pos = pos;
        _row = row;
        if (title != null)
    ...
    public String getButtonText()
    {
        ...
        {
            if (_e != null)
                return Minecraft.getMinecraft().vrSettings.getButtonDisplayString(_e);
        }
    ...
    public Class<? extends GuiScreen> getScreen()
    {
    	return screen;
    }
