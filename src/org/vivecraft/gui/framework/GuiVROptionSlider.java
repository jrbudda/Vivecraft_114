...
public class GuiVROptionSlider extends GuiVROptionButton
{
    ...
    public GuiVROptionSlider(int id, int x, int y, int width, int height, VRSettings.VrOptions option, double min, double max)
    {
        ...
        this.displayString = minecraft.vrSettings.getButtonDisplayString(enumOptions);
    }
    ...
    protected void renderBg(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            if (this.dragging)
            {
                ...
                this.displayString = mc.vrSettings.getButtonDisplayString(this.enumOptions);
            }
    ...
    public void onClick(double mouseX, double mouseY)
    {
        ...
        this.displayString = minecraft.vrSettings.getButtonDisplayString(this.enumOptions);
        this.dragging = true;
    }
