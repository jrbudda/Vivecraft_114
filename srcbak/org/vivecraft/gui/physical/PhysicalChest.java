...
public class PhysicalChest extends PhysicalItemSlotGui {
	...
	public boolean isDouble() {
		...
		IBlockState neighborBlock = mc.world.getBlockState(neighborPos);
	...
	public boolean isFullyClosed() {
		...
		if(te!=null && te instanceof TileEntityEnderChest){
			TileEntityEnderChest teChest=(TileEntityEnderChest) te;
			if( teChest.prevLidAngle==0 && teChest.lidAngle==0){
				wasOpen=false;
				return true;
			}else
	...
	public void open(Object payload) {
		if (payload instanceof IInventory) {
			...
			container = new ContainerChest(mc.player.inventory, inventory, mc.player);
			wasOpen = true;
			super.open(null);
		}
