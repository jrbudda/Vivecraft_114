...
public class PhysicalItemSlotGui extends PhysicalGui {
	...
	public void open(Object payload) {
		if (payload instanceof IInteractionObject && container==null) {
			container = new ContainerWorkbench(mc.player.inventory, mc.world, blockPos);
		}
	...
	public boolean requestOpen() {
		boolean success;
		if (isBlock) {
			success = (mc.playerController.processRightClickBlock(mc.player, mc.world, blockPos, EnumFacing.UP, Vec3d.ZERO, EnumHand.MAIN_HAND)
					== EnumActionResult.SUCCESS);
		} else {
			success = mc.playerController.interactWithEntity(mc.player, entity, EnumHand.MAIN_HAND) == EnumActionResult.SUCCESS;
		}
		return success;
	}
	...
	public void onUpdate() {
		...
		int mainhand = (mc.gameSettings.mainHand == EnumHandSide.RIGHT) ? 0 : 1;
